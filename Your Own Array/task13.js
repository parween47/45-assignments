...
console.log(favorite_transport[2], "give a worst experience according to me");
console.log("Fortuner is my dream", favorite_transport[3]);
console.log("Riding a bicycle is a good habitat.");
